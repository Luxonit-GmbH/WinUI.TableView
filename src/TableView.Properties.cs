...
public partial class TableView
{
    ...
    /// <summary>
    /// Gets or sets a source collection of columns used to populate <see cref="Columns"/>. This is the binding-friendly
    /// alternative to populating <see cref="Columns"/> imperatively.
    /// </summary>
    /// <remarks>
    /// Assigning this property replaces the contents of <see cref="Columns"/> with the supplied columns in a single
    /// pass. If the collection implements <see cref="System.Collections.Specialized.INotifyCollectionChanged"/> (e.g. an
    ...
    /// <summary>
    /// Handles changes to the ColumnsSource property.
    /// </summary>
